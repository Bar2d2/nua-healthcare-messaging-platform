...
Rails.application.configure do
  ...
  # Don't precompile assets in development - serve them directly
  ...
  # Suppress Sass warnings in development
  ...
  config.after_initialize do
    if defined?(Bullet)
      ...
      Bullet.stacktrace_includes = %w[app config lib]
      Bullet.stacktrace_excludes = %w[vendor]
    end
  end
