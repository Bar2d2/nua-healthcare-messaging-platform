...
# Handles and validates message parameters from API and web requests.
# Encapsulates parameter validation logic and provides clean interface for controllers.
class MessageParams
  ...
  # Initialize with message parameters
  ...
  # Check if routing type is valid for message creation
  def valid_routing_type?
    routing_type.blank? || Message.routing_types.key?(routing_type)
  end
